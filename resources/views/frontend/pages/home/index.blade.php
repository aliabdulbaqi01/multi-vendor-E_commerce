...
===========================-->
    ...
    <!--============================
        BANNER PART 2 START
    ==============================-->
@include('frontend.pages.home.sections.banner_slider')
    <!--============================
            BANNER PART 2 END
        ==============================-->
    ...
    <!--============================
        FLASH SELL START
    ==============================-->
    @include('frontend.pages.home.sections.flash_sell')
    ...
    ==============================-->
    @include('frontend.pages.home.sections.monthly_top_product')
    ...
    <!--============================
        BRAND SLIDER START
    ==============================-->
    @include('frontend.pages.home.sections.brand_slider')
    ...
    <!--============================
        SINGLE BANNER START
    ==============================-->
    @include('frontend.pages.home.sections.single_banner')
    ...
    <!--============================
        HOT DEALS START
    ==============================-->
    @include('frontend.pages.home.sections.hot_deals')
    ...
    ==============================-->
    @include('frontend.pages.home.sections.electronic')
    ...
    <!--============================
        ELECTRONIC PART START
    ==============================-->
    @include('frontend.pages.home.sections.electronic2')
    ...
    <!--============================
        LARGE BANNER  START
    ==============================-->
    @include('frontend.pages.home.sections.large_banner')
    ...
    ==============================-->
    @include('frontend.pages.home.sections.weekly_best_item')
